...
select distinct genderid from tbluser;
select * from tbluser where genderid <> '1';
insert into tbluser(id, Name, Email, GenderID, age) values (9, 'sara', 's@r.com', 1, 23)
insert into tbluser(id, Name, Email, GenderID, age) values (10, 'naz', 'n@r.com', 2, 25)
insert into tbluser(id, Name, Email, GenderID, age) values (11, 'sarah','s@s.com', 1, 30)
insert into tbluser(id, Name, Email, GenderID, age) values (12, 'iqra', 'i@r.com', 1, 45)
insert into tbluser(id, Name, Email, GenderID, age) values (13, 'tezz', 't@r.com', 2, 95)
select * from tbluser where age between 20 and 35;
select * from tbluser where email like 'S%';
select * from tbluser where email like '%@%';
select * from tbluser where email like '_@_.com';
select * from tbluser where email like '[jsl]%';
select * from tbluser where email like '[^jsl]%';
select * from tbluser order by age;
select * from tbluser order by age desc;
select top 2 name from tbluser;
select top 1 * from tbluser order by age desc;